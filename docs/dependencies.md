...
OpenCode, Pi, and Ollama are required only for their local AI integrations:
...
Follow [OpenCode and Pi with Ollama](opencode-ollama.md) to install the models and configure their shared short aliases.
