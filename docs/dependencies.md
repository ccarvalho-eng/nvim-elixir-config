...
OpenCode and Ollama are required only for the local AI integration:
...
Follow [OpenCode with Ollama](opencode-ollama.md) to install the models and configure their real names and short aliases.
